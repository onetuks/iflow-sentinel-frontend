...
export const MOCK_TENANTS: Tenant[] = [
  { id: 't1', projectId: 'p1', name: 'DEV', tenantName: 'S-Oil DEV', odataUrl: 'soil-dev.integrationsuite.cfapps...', clientId: '', clientSecret: '', tokenUrl: '', platformType: 'CLOUD_FOUNDRY', status: 'connected', lastChecked: '최근 09:14', packageCount: 22 },
  { id: 't2', projectId: 'p1', name: 'QAS', tenantName: 'S-Oil QAS', odataUrl: 'soil-qas.integrationsuite.cfapps...', clientId: '', clientSecret: '', tokenUrl: '', platformType: 'CLOUD_FOUNDRY', status: 'error', lastChecked: '최근 13:20', packageCount: 22 },
  { id: 't3', projectId: 'p1', name: 'PRD', tenantName: 'S-Oil PRD', odataUrl: 'soil-prd.integrationsuite.cfapps...', clientId: '', clientSecret: '', tokenUrl: '', platformType: 'CLOUD_FOUNDRY', status: 'connected', lastChecked: '3일 전', packageCount: 20 },
];
