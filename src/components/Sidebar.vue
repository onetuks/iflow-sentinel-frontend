  ...
  >
    ...
    >
      ...
      <div v-else-if="activePopover === 'artifact'" class="flex flex-col gap-0.5">
        ...
        <router-link to="/artifact-tracker" class="flex items-center gap-2.5 rounded-lg px-2.5 py-2 font-sans text-[13.5px] font-medium text-muted transition hover:bg-surface-2 hover:text-ink" active-class="bg-primary-tint font-semibold !text-primary-600" @click="activePopover = null"><span>아티팩트 관리</span></router-link>
      </div>
