...
const progressLabel = ref('Ï§ÄÎπ?Ï§ë‚Ä?);
...
<template>
  <div class="animate-fade">
    <div class="mb-6 flex min-h-[44px] flex-wrap items-center gap-3.5">
      <div>
        <h1 class="m-0 font-disp text-2xl font-bold tracking-tight">Í≤Ä???§Ìñâ</h1>
        <div class="mt-1 text-[13px] text-muted">?åÎÑå?∏Ï? iFlowÎ•??†ÌÉù??Í∑úÏπô Í≤Ä?¨Î? ?§Ìñâ?©Îãà??/div>
      </div>
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-[1.5fr_1fr]">
      <div class="rounded-2xl border border-line bg-surface shadow-md">
        <div class="border-b border-line px-5 py-4">
          <h3 class="m-0 font-disp text-[14.5px] font-semibold">?Ä???†ÌÉù</h3>
        </div>
        <div class="p-5">
          <div class="mb-4">
            <label class="mb-1.5 block text-[12.5px] font-semibold text-[#3B4257]">?åÎÑå??/label>
            <div class="flex items-center gap-1.5">
              ...
              >
                <div 
                  ...
                  :class="activeTab === tenant.name ? 'bg-ink text-white shadow-sm' : 'bg-surface-2 text-muted hover:bg-line-2 hover:text-ink'"
                >
          ...
          <div class="mt-4 text-[12px] text-faint font-mono">
            ?ÅÏö© Í∑úÏπô: <span class="font-semibold text-ink">8Í∞?/span> ?¨Ïö© Ï§?(<router-link to="/rulesets" class="text-primary-600 underline decoration-primary-tint-2 underline-offset-2 hover:decoration-primary-600">?ÅÏö© Í∑úÏπô Î≥¥Í∏∞</router-link>)
          </div>
      ...
      <div class="rounded-2xl border border-line bg-surface shadow-md">
        <div class="border-b border-line px-5 py-4">
          <h3 class="m-0 font-disp text-[14.5px] font-semibold">ÏµúÍ∑º ?§Ìñâ</h3>
        </div>
        <div class="overflow-x-auto">
          <table class="w-full border-collapse">
            <thead>
              <tr>
                <th class="border-b border-line px-4.5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-faint">?åÎÑå??/th>
                <th class="border-b border-line px-4.5 py-3 text-left text-[11px] font-semibold uppercase tracking-wide text-faint">?úÍ∞Å</th>
